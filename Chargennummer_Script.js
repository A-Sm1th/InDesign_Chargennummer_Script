...
if(myResult == true){
alert("Chargennummer " + Chargennummer.editContents + ",Artikel-Nr. " +
...
//Search the document for the string "copy" and change it to "text".
    app.findTextPreferences.findWhat = "Chargennummer";
    app.changeTextPreferences.changeTo = Chargennummer.editContents;
